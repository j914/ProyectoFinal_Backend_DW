...
const {consultaCatedratico, guardarCatedratico, eliminarCatedratico, modificarCatedratico, } = require ('../controllers/Catedratico.controller');
const router = Router();

// ruta get 
router.get('/proyectfinal/api/Catedratico' , consultaCatedratico);
